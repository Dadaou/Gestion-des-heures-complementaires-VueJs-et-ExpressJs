...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <table class="mytable">
        ...
        <div class="myNav">
            ...
            <td>
                <input class="form-control" type="search" placeholder="Matricule" v-model= "matriculeSearch">
            </td>
        </tr>
    </table>
</nav>
  ...
  <div class="col">
    <table class="table table-dark" v-show="!showTableEdit">
        ...
        <tr v-for= "item in Liste" :key= "item.Matricule">
            ...
            <td class="text-right">
                <button type="button" class="btn btn-outline-success btn-sm" @click="getEdit(item.Matricule),createdShowfalse(),editShowtrue()">Editer</button>
...
export default {
    ...
    getEdit(matricule){
        axios.get('http://localhost:3000/api/Prof/'+ matricule)
        .then(reponse => {
